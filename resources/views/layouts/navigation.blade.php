        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('experiencias')" :active="request()->routeIs('experiencias')">
                        {{ __('Experiencias') }}
                    </x-nav-link>
                    ...
                    @if(auth()->user()->rol == 'CreadorEventos')
                    <x-nav-link :href="route('eventos')" :active="request()->routeIs('eventos')">
                        {{ __('Eventos') }}
                    </x-nav-link>
                    <x-nav-link :href="route('inscripciones')" :active="request()->routeIs('eventos')">
                        {{ __('Inscripciones') }}
                    </x-nav-link>
